#Documentation - The Blue Alliance API v1 (deprecated)
...
## Deprecation Notice
Version 1 of The Blue Alliance API deprecated, and will no longer work after 1/1/2015. Alternatively you should use [version 2 of the API](http://www.thebluealliance.com/apidocs). More about this can be read at [#1087](https://github.com/the-blue-alliance/the-blue-alliance/issues/1087)
